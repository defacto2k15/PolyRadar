Shader "Custom/SineMatchText"
{
	Properties
	{
		 [PerRendererData] _Color("_Color", Color) = (0.0,1.0,0.0,1.0)
		 _AlphaPowerFactor("_AlphaMultiplier",Range(0,10)) = 1.0
		 _ColorMultiplier("ColorMultiplier",Range(0,10)) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_TARGET
            {
				...
				float3 baseColor = _Color.xyz *_ColorMultiplier;
